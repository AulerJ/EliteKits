...
export function FeedbackWhatsAppCta({ whatsappNumber, className = "" }: FeedbackWhatsAppCtaProps) {
  ...
  const whatsappUrl = `https://wa.me/${cleanNumber}?text=${encodeURIComponent(feedbackMessage)}`;
  ...
  return (
    ...
    >
      ...
      <p className="mt-2 text-zinc-600">
        Sua foto pode aparecer aqui e ajudar outros clientes. Mande uma foto com sua opinião pelo WhatsApp — adoramos saber o que você achou!
      </p>
      <a
        href={whatsappUrl}
        target="_blank"
